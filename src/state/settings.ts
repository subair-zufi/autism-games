...
export const useSettings = create<SettingsState>()(
  persist(
    (set) => ({
      voiceOn: true,
      soundOn: true,
      difficulty: { emotions: 'easy', zebra: 'easy', garden: 'easy', balldrop: 'easy', mirror: 'easy', blocks: 'easy', museum: 'easy', rightway: 'easy', rulefixer: 'easy', weather: 'easy', torch: 'easy', share: 'easy' },
