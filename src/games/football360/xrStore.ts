...
/**
 * Shared WebXR session store for Football 360 (same setup as Museum 360). On a
 * headset (e.g. Meta Quest) the child enters immersive VR and the headset
 * drives the camera — a real head turn replaces the drag-to-look controls. On
 * screens without WebXR the game plays exactly as before; nothing here
 * activates.
 *
...
export const xrStore = createXRStore({
  // the child stands still at the centre spot — no teleport/locomotion
