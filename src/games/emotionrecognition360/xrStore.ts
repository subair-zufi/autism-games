 ...
 * Meta Quest) the child enters immersive VR and the headset drives the camera —
 * a real head turn replaces the drag-to-look controls. On screens without WebXR
