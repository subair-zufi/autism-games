...
export const GAME_LIST: GameMeta[] = [
  ...
  },
  {
    ...
    path: '/garden',
    color: '#22c55e',
    description: 'Share focus on objects',
    objective: 'Follow a shared point of attention to find hidden things',
    duration: '5–10 min',
    hasLevels: false,
  },
  {
  ...
  },
  {
    ...
    objective: 'Practise joint attention on shared objects',
    duration: '5–10 min',
    hasLevels: false,
  },
  {
